...
wget https://raw.githubusercontent.com/dongryphon/VerusCliMining/main/config.json -O ~/config.json
wget https://raw.githubusercontent.com/dongryphon/VerusCliMining/main/miner.sh -O ~/miner.sh
